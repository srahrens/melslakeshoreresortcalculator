		...
		<Row>
			...
			<Col md={8}>
				...
				<Card.Body style={{padding: 0}}>
                    ...
                    <Row>
                        <Button variant="outline-success" style={{marginTop: "5%", width: "95%", fontSize: 30, marginRight: "2.5%", marginLeft: "2.5%"}} onClick={() => props.addItem('Open Liquor', `$${amount}`, setAmount(''))}>Add Item</Button>
                    </Row>
				</Card.Body>
				</Card>
			</Col>
